  ...
  return (
    <div className="w-full">
      <div className="flex justify-between mb-4">
        <Link
          to={ROUTER.profile}
          className={`p-2 rounded-full bg-[#333333] ${location.pathname === ROUTER.profile ? 'text-[#EAA72A] pointer-events-none' : 'text-white hover:text-[#EAA72A]'}`}
        >
          <ProfileIcon />
        </Link>
        <Link
        ...
        <Link
          to={ROUTER.message}
          className={`p-2 rounded-full bg-[#333333]  ${location.pathname === ROUTER.message ? 'text-[#EAA72A] pointer-events-none' : 'text-white hover:text-[#EAA72A]'}`}
        >
          <ChatIcon />
        </Link>
      </div>
